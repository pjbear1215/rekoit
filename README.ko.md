...
- **연결 안정성 강화:** 리마커블의 미완성 블루투스 스택을 보완·확장하여, 블루투스 기기들과의 안정적인 연결을 보장합니다.
...
3. **전체 원상복구 시 수행 작업:**
   - `rekoit-daemon` 서비스 중지 및 런타임 파일 제거
...
- **블루투스 기기 검색 안 됨:** 키보드가 페어링 모드이며 기기 범위 내에 있는지 확인하세요. 표준 페어링 방식을 따르지 않는 일부 아주 오래된 구형 모델은 연결에 어려움이 있을 수 있습니다.
